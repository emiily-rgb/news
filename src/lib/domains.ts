...
export const DOMAIN_MAP: Record<string, MediaInfo> = {
  ...
  // ── 7/14~7/20 누락 매체 ──────────────────────────────────
  'dailypop.kr':            { company: '데일리팝',      mediaType: 'Online' },
  'smedaily.co.kr':         { company: '중소기업신문',  mediaType: 'Newspaper' },
  'swtvnews.com':           { company: 'SWTV',          mediaType: 'Online' },
  'newsway.co.kr':          { company: '뉴스웨이',      mediaType: 'Online' },
  'seouleconews.com':       { company: '서울이코노미뉴스', mediaType: 'Online' },
  'impacton.net':           { company: '임팩트온',      mediaType: 'Online' },
  'sports.hankooki.com':    { company: '스포츠한국',    mediaType: 'Online' },
  'newsian.co.kr':          { company: '뉴시안',        mediaType: 'Online' },
  'thetracker.co.kr':       { company: '더트래커',      mediaType: 'Online' },
  'esgeconomy.com':         { company: 'ESG경제',       mediaType: 'Online' },
  'electimes.com':          { company: '전기신문',      mediaType: 'Newspaper' },
  'cstimes.com':            { company: '컨슈머타임스',  mediaType: 'Online' },
  's-journal.co.kr':        { company: 'S저널',         mediaType: 'Online' },
  'coinreaders.com':        { company: '코인리더스',    mediaType: 'Online' },
  'moneystorm.kr':          { company: '머니스톰',      mediaType: 'Online' },
  'slist.kr':               { company: '싱글리스트',    mediaType: 'Online' },
  'ilovepc.co.kr':          { company: '디지털포스트(PC사랑)', mediaType: 'Online' },
  'cwn.kr':                 { company: 'CWN뉴스',       mediaType: 'Online' },
  'irobotnews.com':         { company: '로봇신문',      mediaType: 'Online' },
  'greened.kr':             { company: '녹색경제신문',  mediaType: 'Online' },
  'thebigdata.co.kr':       { company: '빅데이터뉴스',  mediaType: 'Online' },
  'pennmike.com':           { company: '펜앤마이크',    mediaType: 'Online' },
  'topstarnews.net':        { company: '톱스타뉴스',    mediaType: 'Online' },
  'fntimes.com':            { company: '한국금융신문',  mediaType: 'Online' },
  'fortunekorea.co.kr':     { company: '포춘코리아',    mediaType: 'Online' },
  'smartbizn.com':          { company: '스마트비즈',    mediaType: 'Online' },
  'newscj.com':             { company: '천지일보',      mediaType: 'Online' },

  // ── 7/22~7/23 누락 매체 ──────────────────────────────────
  'livesnews.com':          { company: '라이브뉴스',    mediaType: 'Online' },
  'nextdaily.co.kr':        { company: '넥스트데일리',  mediaType: 'Online' },
  'sisacast.kr':            { company: '시사캐스트',    mediaType: 'Online' },
  'tournews21.com':         { company: '투어코리아',    mediaType: 'Online' },
  'ppss.kr':                { company: 'PPSS',          mediaType: 'Online' },
  'newsprime.co.kr':        { company: '프라임경제',    mediaType: 'Online' },
  'hbnpress.com':           { company: 'HBN뉴스',       mediaType: 'Online' },
  'sisaon.co.kr':           { company: '시사오늘',      mediaType: 'Online' },
  'shinailbo.co.kr':        { company: '신아일보',      mediaType: 'Newspaper' },
  'm-joongang.com':         { company: '월간중앙',      mediaType: 'Online' },
  'dailycar.co.kr':         { company: '데일리카',      mediaType: 'Online' },
  'kpinews.kr':             { company: 'KPI뉴스',       mediaType: 'Online' },
}
