...
<table width="760" cellpadding="0" cellspacing="0" class="email-container" style="background:#fff;border-radius:4px;overflow:hidden;max-width:760px;box-shadow:0 1px 4px rgba(0,0,0,0.08)">
