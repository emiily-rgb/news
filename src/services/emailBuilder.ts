...
<table width="680" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:6px;overflow:hidden;max-width:680px">
  ...
  <tr><td style="background:#c8102e;padding:20px 24px">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td>
        <img src="https://news-ebon-alpha.vercel.app/huawei-logo.png" alt="HUAWEI" width="120" height="auto" style="display:block;margin-bottom:6px;filter:brightness(0) invert(1);max-width:120px" />
